...
from .actions.edit_action import GptImageEditAction
...
class GptImage2Plugin(BasePlugin):
    ...
    async def on_plugin_loaded(self) -> None:
        ...
        if custom:
            for action_cls in (GptImageDrawAction, GptImageSelfieAction, GptImageEditAction):
    ...
    def get_components(self) -> list[type]:
        ...
        if cfg.components.action_enabled:
            components.extend([GptImageDrawAction, GptImageSelfieAction, GptImageEditAction])
